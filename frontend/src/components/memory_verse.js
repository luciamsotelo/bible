...
const MemoryVerse = () => {
  ...
  return (
    <div className="memory-verse-container">
      ...
      <p className="memory-verse-container" style={{ fontFamily: "quicksand", color: "black", textShadow: "2px 1px 2px #ff5733", margin: "8px 20px"}} ref={verseRef}>{memoryVerses[verseIndex]}</p>
    </div>
  );
};
