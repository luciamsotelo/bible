...
const stories = [
  {
    ...
    lesson: "Obedience to God: God gave Adam and Eve a rule to follow, but they disobeyed. This teaches us the importance of listening to and obeying God’s instructions."
  },
  {
    title: "Noah's Ark",
    frontImage: Ark,
    ...
    lesson: "Faith in God’s plan: Noah trusted in God’s instructions, even when others didn’t believe him. This teaches us the importance of faith and obedience, knowing that God will guide and protect those who trust in Him."
  },
  {
    ...
    lesson: "With God, even the smallest can overcome great challenges. David’s story teaches us that faith and courage can help us confront our fears and achieve great things."
  },
  
  {
    ...
    lesson: "When we trust God, He will take care of us. Daniel teaches us to be brave and always pray, no matter what."
  },
  
  {
    ...
    lesson: "God loves everyone and gives us second chances. Jonah teaches us that we should listen to God and help others."
  }
  ,
  {
    ...
    lesson: "Trusting God in difficult times: Moses and the Israelites trusted God, even when they were afraid. This teaches us that God is always with us and will help us through any challenge if we trust in Him."
  }
];
